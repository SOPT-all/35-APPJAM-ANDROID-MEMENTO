...
internal abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindsLoginRepository(loginRepositoryImpl: MemberRepositoryImpl): MemberRepository
